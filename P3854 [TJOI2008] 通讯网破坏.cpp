//  Author: Tangyixiao
// Time: 2026-07-03 10:25:42
//  Problem: P3854 [TJOI2008] 通讯网破坏
//  Contest: Luogu
//  URL: https://www.luogu.com.cn/problem/P3854
//  Memory Limit: 125 MB
//  Time Limit: 2000 ms
//  Interactive: false
//  Test Type: single
//  Batch ID: 9ae2a085-e71e-49ce-8b42-5267688be341
//
// Algorithm:
// Complexity: O()
// Note:
...
const int N = 20005, M = 100005, MAXN = N + M + 5;
int n, m, Q;
int h1[N], e1[M * 2], ne1[M * 2], id1;
int h2[MAXN], e2[MAXN * 4], ne2[MAXN * 4], id2;
...
int dfn[N], low[N], timer, stk[N], top, dcc_cnt;
