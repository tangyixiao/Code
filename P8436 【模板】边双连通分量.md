...
The first line contains an integer $x$, representing the number of edge biconnected components.

The next $x$ lines: in each line, the first number is $a$, the number of vertices in this component, followed by $a$ numbers describing an edge biconnected component.
...
### Data Updates
- $2022/7/14$ testdata strengthened.
- $2022/11/26$ added $10$ new smaller test groups ($1 \le n, m \le 10$) to make debugging easier.
- $2022/12/31$ reorganized the $subtask$ setup and added several groups of extreme testdata.
- $2023/1/1$ found issues in the newly added testdata from yesterday, and fixed them.
------------
