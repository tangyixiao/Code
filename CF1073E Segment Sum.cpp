//  Author: Tangyixiao
//  Time: 2026-08-16 08:16:25
//  Problem: E. Segment Sum
//  Contest: Codeforces - Educational Codeforces Round 53 (Rated for Div. 2)
//  URL: https://codeforces.com/contest/1073/problem/E
//  Memory Limit: 256 MB
//  Time Limit: 1000 ms
//  Interactive: false
//  Test Type: single
//  Batch ID: de254b56-0b59-4884-9088-ebe26784c14d
//
// Algorithm:
// Complexity: O()
// Note:
...
Node dfs(int p, int m, bool lim, bool lead) {
    if (p == n) {
        if (lead)
            return {0, 0};
        return {__builtin_popcount(m) <= k, 0};
    }
    ...
    for (int d = 0; d <= up; d++) {
        ...
        res.s = (res.s + t.s + t.c * d % P * pw[len]) % P;
    }
