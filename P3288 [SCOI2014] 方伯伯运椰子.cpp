//  Author: Tangyixiao
//  Time: 2026-08-12 08:22:40
//  Problem: P3288 [SCOI2014] 方伯伯运椰子
//  Contest: Luogu
//  URL: https://www.luogu.com.cn/problem/P3288
//  Memory Limit: 125 MB
//  Time Limit: 1000 ms
//  Interactive: false
//  Test Type: single
//  Batch ID: 22ff4990-b840-4dee-ac63-8b8fc56af435
//
// Algorithm:
// Complexity: O()
// Note:
...
int tot, h[N];
void add(int u, int v, int f) { e[++tot].v = v, e[tot].f = f, e[tot].nex = h[u], h[u] = tot; }
bool vis[N];
double dis[N];
