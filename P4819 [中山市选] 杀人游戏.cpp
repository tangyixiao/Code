...
//  Interactive: false
//  Test Type: single
//  Batch ID: fe4cb5ad-d22f-404c-a85b-a4c57af861bf
//
// Algorithm:
// Complexity: O()
// Note:
...
int n, m;
vector<int> g[N];
int dfn[N], low[N], stk[N], ins[N], tp, tim, sc, id[N], sz[N];
vector<int> scg[N];
int ind[N], deg[N], f[N], z[N], zc, bad[N];
