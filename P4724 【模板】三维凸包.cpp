//  Author: Tangyixiao
//  Time: 2026-08-15 07:46:35
//  Problem: P4724 【模板】三维凸包
//  Contest: Luogu
//  URL: https://www.luogu.com.cn/problem/P4724
//  Memory Limit: 125 MB
//  Time Limit: 1000 ms
//  Interactive: false
//  Test Type: single
//  Batch ID: 62c3ca63-5d2d-452f-ac4f-87621dc00524
//
// Algorithm:
// Complexity: O()
// Note:
...
bool see(F f, P p) {
    return dt(p - a[f.a], cr(a[f.b] - a[f.a], a[f.c] - a[f.a])) > 0;
}

double ar(F f) {
    return len(cr(a[f.b] - a[f.a], a[f.c] - a[f.a])) / 2;
}

double rd() {
    return (rand() * 2.0 / RAND_MAX - 1) * E;
}
...
inline void solve(int Task_Id) {
    ...
    cout << fixed << setprecision(3) << ans + E << "\n";
