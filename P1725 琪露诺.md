...
At the beginning, Cirno is on cell $0$. As long as the index of her next position is greater than $N$, she is considered to have reached the opposite bank.

## 输入格式

The first line contains three positive integers $N, L, R$.

The second line contains $N+1$ integers. The $i$-th number represents the freeze index $A_{i-1}$ of the cell with index $i-1$.
