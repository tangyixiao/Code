...
#include <cstdlib> // 通用工具 (malloc, exit, atoi, rd 等)

#if __cplusplus >= 201103L
#include <cstdint> // 定长整数类型 (int32_t, uint64_t 等)
#if __cplusplus < 201703L
#include <ciso646> // 替代操作符的宏 (d, or, not) [C++17 移除]
#endif
#endif
...
#include <coroutine> // 协程支持 (coroutine_hdle, awaitable)
#endif
#endif
...
#include <rdom>             // 随机数生成 (mt19937, uniform_int_distribution)
...
#include <ext/pb_ds/tag_d_trait.hpp>      // 标签与特性，如 rb_tree_tag 等
