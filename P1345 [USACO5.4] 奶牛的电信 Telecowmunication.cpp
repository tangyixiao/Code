//  Author: Tangyixiao
//  Time: 2026-08-18 14:20:14
//  Problem: P1345 [USACO5.4] 奶牛的电信 Telecowmunication
//  Contest: Luogu
...
//  Interactive: false
//  Test Type: single
//  Batch ID: a415b0b6-3fa7-4c36-b4ff-5cc99af596f0
//
// Algorithm:
// Complexity: O()
// Note:
...
namespace TANGYIXIAO {
const int N = 205, M = 5005, INF = 1e9;
int n, m, s, t, S, T, ec = 1, h[N], to[M], nx[M], w[M];
int d[N], cur[N], q[N];
