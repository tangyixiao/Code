...
# P4400 [JSOI2008] Blue Mary's Trip
...
The first line contains $3$ positive integers $N$, $M$ and $T$.  
...
Output a single line with one positive integer, the earliest possible day on which the last person arrives in city B. Assume the first day they take a flight is day $1$.
