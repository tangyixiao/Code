//  Author: Tangyixiao
//  Time: 2026-08-16 07:41:47
//  Problem: P12597 穿睡衣军训
//  Contest: Luogu
//  URL: https://www.luogu.com.cn/problem/P12597
//  Memory Limit: 512 MB
//  Time Limit: 1000 ms
//  Interactive: false
//  Test Type: single
//  Batch ID: 762fb3a3-da17-4dd4-a007-a348304a5bb9
//
// Algorithm:
// Complexity: O()
// Note:
...
inline void solve(int Task_Id) {
    ...
    while (T--) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (l > bl || (l == bl && l && s.compare(i, l, s, bs, bl) < 0)) {
                bl = l;
                bs = i;
            }
        }
