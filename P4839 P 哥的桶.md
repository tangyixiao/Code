...
P Bro now has $n$ buckets arranged in a row. These buckets can hold any number of balls. Each ball has a fixed value.
...
The first line contains two integers $n, m$, which represent the number of operations P Bro performs, and the maximum index involved in this testdata, respectively.

The next $n$ lines each contain three integers describing an operation. The operation format is as described in the statement.
...
For $20\%$ of the data, $n, m \leq 100$.
