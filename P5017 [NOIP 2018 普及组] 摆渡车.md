...
The second line contains $n$ non-negative integers, separated by spaces. The $i$-th non-negative integer $t_i$ represents the time when the $i$-th student arrives at the station.
