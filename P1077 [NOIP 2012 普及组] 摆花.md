...
The first line contains two positive integers $n$ and $m$, separated by a single space.

The second line contains $n$ integers, separated by single spaces, representing $a_1, a_2, \cdots, a_n$.
