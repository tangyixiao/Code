...
//  Problem: P1178 到天宫做客
//  Contest: Luogu
//  URL: https://www.luogu.com.cn/problem/P1178
//  Memory Limit: 125 MB
//  Time Limit: 1000 ms
//  Interactive: false
//  Test Type: single
//  Batch ID: d4e5af6d-2330-400b-8a30-014e24402acf
//
// Algorithm:
// Complexity: O()
// Note:
...
namespace TANGYIXIAO {
const int N = 1e6 + 5, mon[] = {0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335, 366};
struct node {
    int m, d;
...
inline void solve(int Task_Id) {
    ...
    sort(s + 1, s + 2 + n);
    cout << round(s[n + 1] / 366.0 * 86400.0);
    return;
}
} // namespace TANGYIXIAO
