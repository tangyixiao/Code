//  Author: Tangyixiao
//  Time: 2026-08-24 10:38:44
//  Problem: U105031 冻住不许跳
//  Contest: Luogu - SXYZ 训练赛①
//  URL: https://www.luogu.com.cn/problem/U105031?contestId=352491
//  Memory Limit: 125 MB
//  Time Limit: 1000 ms
//  Interactive: false
//  Test Type: single
//  Batch ID: 6f9c4a23-9c5d-404c-8c92-7784e14c02e4
//
// Algorithm:
// Complexity: O()
// Note:
...
inline void solve(int Task_Id) {
    ...
    for (int i = 1, d = inf, id; i <= n; i++, d = inf) {
        if (!flag[i]) {
            for (int j = a[i].s; j >= 1; j--) {
                if (a[vis[j]].c < d) {
                    d = a[vis[j]].c;
