//  Author: Tangyixiao
// Time: 2026-07-10 11:03:24
//  Problem: P4799 [CEOI 2015] 世界冰球锦标赛 (Day2)
//  Contest: Luogu
...
//  Interactive: false
//  Test Type: single
//  Batch ID: 4fc57d8a-270b-4d6b-9673-9ac8602fdff7
//
// Algorithm:
// Complexity: O()
// Note:
...
namespace TANGYIXIAO {
const int N = 55;
int n, m, w[N], mid, suma[1 << 21], sumb[1 << 21], cnta, cntb, ans;
