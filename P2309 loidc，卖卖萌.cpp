//  Author: Tangyixiao
// Time: 2026-08-15 23:09:08
//  Problem: P2309 loidc，卖卖萌
//  Contest: Luogu
//  URL: https://www.luogu.com.cn/problem/P2309
//  Memory Limit: 125 MB
//  Time Limit: 1000 ms
//  Interactive: false
//  Test Type: single
//  Batch ID: 8747ead6-b723-4330-857e-e5cafa190802
//
// Algorithm:
// Complexity: O()
// Note:
...
inline void solve(int Task_Id) {
    ...
    m = unique(s, s + n + 1) - s;
    for (int i = 0; i <= n; i++) {
        int v = lower_bound(s, s + m, p[i]) - s + 1;
        A += Q(v - 1);
        U(v);
    }
    cout << A;
