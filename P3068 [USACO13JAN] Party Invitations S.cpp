//  Author: Tangyixiao
//  Time: 2026-08-14 16:12:50
//  Problem: P3068 [USACO13JAN] Party Invitations S
//  Contest: Luogu
//  URL: https://www.luogu.com.cn/problem/P3068
//  Memory Limit: 125 MB
//  Time Limit: 1000 ms
//  Interactive: false
//  Test Type: single
//  Batch ID: 60f15003-2d56-4fd4-bf17-a2bb34514a03
//
// Algorithm:
// Complexity: O()
// Note:
...
namespace TANGYIXIAO {
const int N = 1e6 + 5;
int h[N], to[N], ne[N], c[N], x[N], q[N], ec;
bool v[N];
inline void solve(int Task_Id) {
    int n, g;
    cin >> n >> g;
