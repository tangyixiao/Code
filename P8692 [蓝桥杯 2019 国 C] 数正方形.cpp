//  Author: Tangyixiao
//  Time: 2026-09-08 07:48:11
//  Problem: P8692 [蓝桥杯 2019 国 C] 数正方形
//  Contest: Luogu
//  URL: https://www.luogu.com.cn/problem/P8692
//  Memory Limit: 128 MB
//  Time Limit: 1000 ms
//  Interactive: false
//  Test Type: single
//  Batch ID: 81175c72-d4b4-488d-8d2f-94d4f84711ae
//
// Algorithm:
// Complexity: O()
// Note:
...
namespace TANGYIXIAO {
const long long mod = 1e9 + 7, inv12 = 83333334;
long long n;
inline void solve(int Task_Id) {
    cin >> n;
    cout << (n % mod * n % mod) * (((n % mod * n % mod) - 1 + mod) % mod) % mod * inv12 % mod << '\n';
    return;
}
} // namespace TANGYIXIAO
