//  Author: Tangyixiao
//  Time: 2026-09-23 15:29:38
//  Problem: P14838 [THUPC 2026 初赛] 序列
//  Contest: Luogu
//  URL: https://www.luogu.com.cn/problem/P14838
//  Memory Limit: 512 MB
//  Time Limit: 1000 ms
//  Interactive: false
//  Test Type: single
//  Batch ID: 8a2e121d-90fb-4b95-bfd4-1734f6f6bc17
//
//  Algorithm:
//  Complexity: O()
//  Note:
...
inline void solve(int Task_Id) {
    ...
    int f = __builtin_ctzll((unsigned long long)m);
    ll g = m >> f;
    ...
    while (g != 1) {
        ...
        int k = 64 - __builtin_clzll((unsigned long long)g);
