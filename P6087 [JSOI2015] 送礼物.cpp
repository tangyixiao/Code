//  Author: Tangyixiao
//  Time: 2026-08-12 08:07:04
//  Problem: P6087 [JSOI2015] 送礼物
//  Contest: Luogu
//  URL: https://www.luogu.com.cn/problem/P6087
//  Memory Limit: 512 MB
//  Time Limit: 3000 ms
//  Interactive: false
//  Test Type: single
//  Batch ID: 066a7bfb-a487-4685-a45b-3438f7f9287a
//
// Algorithm:
// Complexity: O()
// Note:
...
inline void push(int pos, double val) {
    while (l <= r && dl[r] <= val)
        --r;
    ++r;
    dl[r] = val;
...
inline void push2(int pos, double val) {
    while (l <= r && dl[r] >= val)
        --r;
    ++r;
    dl[r] = val;
