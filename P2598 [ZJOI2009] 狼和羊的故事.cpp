//  Author: Tangyixiao
//  Time: 2026-08-18 13:45:22
//  Problem: P2598 [ZJOI2009] 狼和羊的故事
//  Contest: Luogu
//  URL: https://www.luogu.com.cn/problem/P2598
//  Memory Limit: 125 MB
//  Time Limit: 1000 ms
//  Interactive: false
//  Test Type: single
//  Batch ID: f92cb6ee-d3de-4d9f-bafc-f04ec4694a1a
//
// Algorithm:
// Complexity: O()
// Note:
...
namespace TANGYIXIAO {
const int N = 10005, M = 100005, INF = 1e9;
int n, m, S, T, ec = 1, h[N], to[M], nx[M], w[M];
int d[N], cur[N], q[N], a[105][105];
