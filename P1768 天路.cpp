//  Author: Tangyixiao
//  Time: 2026-08-12 08:12:40
//  Problem: P1768 天路
//  Contest: Luogu
//  URL: https://www.luogu.com.cn/problem/P1768
//  Memory Limit: 500 MB
//  Time Limit: 1000 ms
//  Interactive: false
//  Test Type: single
//  Batch ID: 2f798b1f-0e8a-4531-98b3-b9a90f42056d
//
// Algorithm:
// Complexity: O()
// Note:
...
inline void solve(int Task_Id) {
    ...
    for (int i = 1; i <= m; i++) {
        ...
        double x, y;
        cin >> u >> v >> x >> y;
        e[u].push_back((node){v, x, y, 0});
    }
    for (int i = 1; i <= n; i++) {
        e[0].push_back((node){i, 0, 0, 0});
    }
    double l = 0, r = 200;
    double ans = -1;
    for (int i = 1; i <= 15; i++) {
