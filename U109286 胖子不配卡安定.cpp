//  Author: Tangyixiao
//  Time: 2026-09-08 07:35:32
//  Problem: U109286 胖子不配卡安定
//  Contest: Luogu - SXYZ 训练赛③
//  URL: https://www.luogu.com.cn/problem/U109286?contestId=354865
//  Memory Limit: 125 MB
//  Time Limit: 1000 ms
//  Interactive: false
//  Test Type: single
//  Batch ID: e825938e-e449-41c7-a6c3-9de0a24c7311
//
// Algorithm:
// Complexity: O()
// Note:
...
namespace TANGYIXIAO {
const int N = 2e4 + 5, inf = (1LL << 31) - 1;
int n, cnt, sum, l = 1, r = inf, a[N], b[N], c[N];
